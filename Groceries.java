...
public class Groceries {
  ...
  */
  ...
  double width = Information.chocolateBoxWidth;
  Chocolate chocolate1 = new Chocolate (chocolateNumber, width); //Creating object with Oranges ordered
  System.out.println(chocolate1); //Console Apple Order
  System.out.println("The total bill for Chocolate is: " + Information.printMoney(chocolate1.getTotalCost() ) );
